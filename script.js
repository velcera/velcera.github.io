    ...
    function renderSliders(sliderIssues) {
        ...
        if (slideElements.length > 1) {
            ...
            setInterval(() => {
                ...
                slideElements[prevSlide].classList.remove('active');
                slideElements[prevSlide].classList.add('exit');
                
                currentSlide = (currentSlide + 1) % slideElements.length;
                slideElements[currentSlide].classList.add('active');
                
                setTimeout(() => {
                    slideElements[prevSlide].classList.remove('exit');
                }, 1000); // Wait for transition to complete before resetting
            }, 3000);
        }
    }
